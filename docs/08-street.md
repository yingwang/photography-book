...
*Eugène Atget 在巴黎拍了三十多年。他从来不自称艺术家，而是把自己的工作看作在拆迁和改造前留住巴黎。他常在清早出门，背着大木相机和玻璃底片，在街上还没有完全热闹起来时拍那些门面、橱窗、街角和院落。生前他从未成名，照片一直只被当作给艺术家的资料按册售卖。1927 年他去世后，年轻的美国摄影师 Berenice Abbott 在画商 Julien Levy 的出资协助下，于次年买下他工作室里的一千三百余张底片和数千张照片，运回纽约，几十年后整批藏进 MoMA。后来人们承认的街头摄影，很大一部分就从这种安静、长期、不急着发表的观看开始。 (Wikimedia Commons, 公有领域)*
...
再往后，彩色街头才慢慢进入正统。公认的分水岭，是第 4 章讲过的 1976 年 Eggleston 那场 MoMA 个展；而把彩色真正带进街头讨论的，是 Joel Meyerowitz、Stephen Shore、Helen Levitt 这一批各自为战的摄影师——Meyerowitz 六十年代就带着彩色胶卷上纽约街头，偏要逆着当时人人默认的黑白正统走。Martin Parr 则用刺眼的闪光灯去拍英国海滨的度假者，照片里满是热狗、泳衣、廉价的消费和那种说不清的尴尬，他不回避俗气，反而正对着俗气去拍。他那组《The Last Resort》（1983 至 1985 年）拍的就是利物浦附近一个叫 New Brighton 的破败海滨浴场，饱和到近乎失真的色彩配上大白天的闪光，把拥挤、脏乱和普通人的假日一并端到眼前，当年也因为如此呈现工人阶级的度假者而引出过不小的争议。Alex Webb 走的又是另一路，他在墨西哥、海地、伊斯坦布尔拍多层次的彩色画面，一张照片里往往有好几件事同时发生：前景里有人打电话，中景里孩子追着球跑，远处的门洞里还有人正望过来。每一个层次都各自独立，彼此之间却被颜色和构图悄悄牵在一起，谁也离不开谁。
...
沿着这条标准推到底，就绕不开你口袋里那台手机。论安静、论不起眼、论丢了不心疼，手机把四条标准占了三条半：满街的人都举着手机，没有人会因为你也举着一台而多看一眼，这份天然的隐身，是任何相机都换不来的。它的短处也要认清楚：固定的广角逼着你必须走近；快门与对焦的反应有一点迟滞，追快速的瞬间不如相机顺手；夜里的多帧合成会把移动的人抹出鬼影。可这些限制没有一条挡得住观看，前面讲的找光、找背景、等交汇，在手机上一条不少。要提防的反而是另一头的便利：手机拍完顺手就能发出去，从按下到公开只隔着两次点击，本章后面要讲的那些关于发布的分寸，在手机上被压缩得最短，也最容易被略过。
...
白天不论晴天还是阴天，都可以用 A 模式，或者 M 模式再配上 Auto ISO。光圈定在 f/5.6 到 f/8 之间，这一档景深足够深，容得下轻微的对焦误差；快门保持在 1/500 秒左右，用来冻结行人正常的走动——注意 A 模式下快门是相机说了算，要让它守住这条线，得进 Auto ISO 菜单，把“最低快门速度”设成 1/500，否则光线一暗，相机会自作主张把快门放慢，而 M 模式加 Auto ISO 则是三样都由你直接指定；ISO 的自动上限放到 6400，给暗一点的角落留出余地。对焦用单次 AF、中心点、后键对焦，测光用评价测光，镜头是 35mm 定焦。这样一组设置能覆盖大多数白天的街头，遇到特殊光线当然还要临时调整，但至少它让你在举起相机的那一刻，不必再从零开始一项项去设，而是可以直接去看、去等、去按。
...
这就是一代代街头摄影师预对焦的底气所在。把 28mm 收到 f/8、对到约 3 米，从一米半开外一直到天边都在景深里，遇到瞬间抬手就按，省掉了对焦这一步的延迟。它也正好接上前面提过的那一招：既然焦点早已锁定，你甚至不必把相机举到眼前去瞄，挂在胸前也能拍准——森山大道满街游走、不把相机举到眼前的拍法，Bruce Gilden 闪光灯下那种出手极快的路数，底子都是这一套。倒是要替布列松说清楚：他从来不盲拍，那双眼睛始终贴在取景器上，把画面的几何算到最后一毫米；预对焦替他省下的，是合焦的时间，不是构图的功夫。这张表背后的推导，第 5 章讲超焦距公式时已经交代过，这里只是把结论直接搬到街上来用。
...
如果你想尝试 Bruce Gilden 或 William Klein 那条近距离直闪的路，参数通常是 f/8、1/250 秒、低 ISO，闪光灯用 TTL 再把闪光补偿压低三分之一到一档。这几个数各有来历，值得说破：1/250 不是随手选的，它是多数焦平面快门的闪光同步速度上限，快过这个速度，帘幕来不及全开，画面会被切掉一条——前面提过的 X100 那类镜间快门机型是例外，它任何速度都能同步，这也是不少直闪拍摄者偏爱它的一层不常明说的缘由；压低闪光补偿，是让闪光只作提亮主体的补光，而不至于把环境也一并照得惨白，白天直闪真正的味道，恰恰在闪光与日光叠出来的那层薄薄的不自然。但必须说清楚，这种方式带着很强的侵入性，争议也一直很大，它几乎是把镜头和闪光灯一起送到陌生人脸上。稳妥的做法，是先看足够多的作品，也看一些实际拍摄的视频，了解现场究竟是什么样子，再决定自己能不能接受，也能不能承担后果。不要只因为它看上去“有风格”就贸然模仿。
...
另一种更可控的做法是追随拍摄（panning，摇摄）。你把快门放在 1/30 到 1/60 秒，然后让镜头跟着一个横向移动的主体一起转，骑车的人、跑动的孩子、驶过的电车都可以。只要转动的速度和对方大致同步，主体就相对清楚，而静止的背景反倒被拉成一道道横向的线条，速度感便由此显现。转身要以腰为轴、按完继续跟，失败的种种成因怎样排查，第 6 章已经细讲过；街头比赛道多出的一层难处，是主体的速度参差不齐，先练熟一种速度的目标，比如电动车，再换下一种，远比见什么追什么长进得快。

要提醒的是，慢门在白天光线过强时容易过曝，这时往往得加一片减光镜（ND，neutral density，中性灰滤镜）把进光压下来，才能把快门放到那么慢。账可以照第 9 章的换算来算，这里给一个够用的例子：晴天 f/16、ISO 100 的快门约在 1/125 秒，挂一片三档的 ND8，就落到 1/15 秒，正好进了拖影的区间。所以白天玩慢门要备一片 ND；而清晨、黄昏和夜里光线本就不强，快门自然慢得下来，那也正是街上灯光与人流最容易叠出气氛的时刻。
...
在大多数国家，公共场合是可以拍照的，包括拍到能被认出来的陌生人，只是这些照片若要用于商业用途，通常还需要另外获得授权。这条“编辑与艺术用途宽、商业用途严”的分界，几乎是各国通例，值得先记住。但落到具体地方，尺度差得很远。法国有一套很严的形象权（droit à l'image）传统，未经同意发布可辨认的个人肖像，被诉的风险是实打实的，这也是为什么不少法国街头摄影师的画册要么只拍背影，要么索性等诉讼时效过去之后再出版。德国的《艺术著作权法》原则上要求发布前征得同意，只给艺术创作和时事报道留了例外。日本法律上宽松，社会习俗却极重私人边界，镜头对人被视为失礼，纠纷多不在法庭而在现场。在中国，民法典把肖像权写得很明确：以营利为目的使用他人肖像必须经过同意，而不以营利为目的的拍摄本身通常不构成侵权，真正的敏感点在发布环节——把可辨认的陌生人发到社交平台并配上调侃的文字，正是最常见的侵权形态；此外，商场、写字楼、地铁站这类半公共空间，物业和保安有权制止拍摄，被制止时照办便是，不必在现场争辩权利的归属。但法律终究只是底线，达到底线远不等于做得体面。有几条不成文的分寸值得始终守住：不要把流浪者的窘态当成奇观来消费，不要专门去拍醉酒者、受伤的人、残疾人那些难堪的瞬间，不要为了效果让一位老人显得可怜，也不要把儿童的正面照片随随便便就发布出去。工人在劳作时当然可以拍，但前提是让画面里的人保有尊严。
...
去一个陌生城市之前，最好花上十分钟，查一查当地关于街头摄影的法律和习俗。这一点相当现实，因为在一处稀松平常的举动，换个地方可能就相当冒犯。此外，无论在哪里，有几类地方都不要去碰：机场、政府机关、军事设施，以及任何明确写着禁止拍照的场所。
