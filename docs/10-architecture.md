...
像场比传感器大出这么多，还顺带赋予了移轴另一样本事：无视差接片。机身和镜头都固定不动，只转动平移旋钮——先左移拍一张，移回中央拍一张，再右移拍一张——三张截取的是同一个像场里并排的三块，视点丝毫没变，近景远景之间不存在任何错位，后期几乎无缝地拼成一张两倍宽、像素也翻倍的大图。这比第 9 章讲的旋转接片省心得多：旋转接片要操心入瞳、要提防近景错位，移轴接片根本没有这些问题，因为你转动的不是相机，而是截取的窗口。竖向同理，上移、居中、下移各拍一张，拼出一张长幅。建筑摄影要交出大尺寸成品时，这一手几乎是移轴用户的常规操作——买一支移轴，等于顺带买下了一台更大画幅的相机。
...
雨后和雾中，也都值得专门挑这样的天气出门。雨后湿漉漉的地面，会像一面镜子那样，把楼和灯统统倒映回来；雾则会把远处高楼的下半截整个吞掉，只留下顶部孤零零地浮在半空中。许多城市在大晴天里其实平平无奇，可一旦罩进雾里，反而生出了一点只属于它自己的秘密。拍雾天有两件技术上的事要先记下：其一，雾是亮场景，和雪同理，测光表会把满画面的灰白往中灰上压，把雾拍得又灰又闷，通常要主动加大半档到一档曝光，让雾回到它本来的亮；其二，白平衡别急着把雾里那点青蓝校掉，那层冷色正是雾自己的体温。器材上还有一件事：从暖的车里、屋里走进冷雾，镜片会立刻蒙上一层结露，急不得，把相机连包在室外放上十来分钟，让它自己降到环境温度再开工，拿布反复去擦只会越擦越花。
...
城市摄影比单纯的建筑，多出了人和时间这两样东西。天际线是其中门槛最低、也最容易拍得千篇一律的一种。机位决定一大半：桥上能把河道当前景，山顶和观景台给你把整座城压成图案的高度，高楼的窗边则常常要对付玻璃反光——把镜头贴住玻璃、用衣服或遮光罩挡掉身后的室内灯，是行之有效的笨办法。找机位不必从零开始，别人拍过什么角度，地图和图片搜索里一查便知，真正的功夫在于挑一个别人没等过的天气和钟点。街区这一层，则要把眼光从单栋楼放宽到组织方式上：一条街的骑楼怎样连成连续的檐口，店招怎样一层压一层地挤占立面，电线怎样把天空切成碎块——这些常被嫌乱的东西，恰恰是一座城市区别于另一座的指纹，与其绕开它们去找“干净”的画面，不如把这份密度本身当作主题，一条街一条街地拍成系列。至于街角，它其实已经很接近街头摄影了，一个人一个不经意的动作，都可能决定整张照片的成败。有一条经验值得记住：让建筑占去画面的大部分，人只在其中出现那么一点点，往往比把画面拍得满是人更耐看。建筑负责提供秩序，人则负责提供那个转瞬即逝的瞬间。
...
礼数之外，还有一层是法律，值得专门立一节说清楚，因为建筑摄影在这上面的误会格外多。底子是宽松的：站在公共道路上拍摄一栋建筑的外观，在绝大多数地方都合法，无须任何人的许可，建筑师和业主都拦不住你的镜头。分歧出在发表和商用这一层，各国的“全景自由”（freedom of panorama）宽窄不一：德国、英国这类地方，公共空间里的建筑随便拍随便发，商用也行；法国则把建筑当作品保护到设计师去世后七十年，最出名的例子是埃菲尔铁塔——铁塔本身早已过了保护期，白天怎么拍都行，可塔身上那套灯光秀是 1985 年的“作品”，夜间点亮的铁塔照片在法国严格说来不能未经授权商用，这桩轶事几乎成了讲全景自由必举的案例。往里走一层，商场、写字楼大堂、酒店、机场航站楼这些看似公共的空间，法律上是私人物业，物业有权立规矩、有权请你收起相机，被制止时照办便是。真接了商业委托去拍一栋楼，规矩再进一层：进入私人地界需要业主许可，成片商用最好把物业授权白纸黑字签下来。至于无人机航拍，则是另一套完全独立的法规——禁飞区、限高、飞手执照，各国各城自成体系，起飞之前把当地规则查清楚，是和检查电池同一级别的起飞前动作。
