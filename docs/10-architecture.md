...
移轴镜头之所以值得单独说一说，是因为它握着两组彼此独立的动作。头一组叫平移（shift）：让镜头相对于传感器，上下或左右地平行移动。它的用处在于，你可以让相机始终保持水平、竖直线毫不变形，却又能把原本落在取景范围之外的高处楼顶一并收进画面，而这一手，恰恰是建筑摄影最为看重的能力。另一组叫倾斜（tilt），它动的不是位置，而是焦平面的朝向。平常拍照的时候，合焦的那个面总是与传感器平行，像一块直立在你面前的玻璃，只有恰好贴在这块玻璃上的东西才最实；倾斜镜头，等于把这块合焦的玻璃从直立扳成倾斜。它背后是一条叫作沙姆定律（Scheimpflug）的几何：只要把镜头平面、传感器平面和被摄物所在的平面各自延伸出去，三者会交于空间里同一条直线，于是镜头一倾，合焦面就绕着这条线转了过来，跟着倒向你想要的方向。这一手对建筑的用处，是当你斜对着一面墙、一条长廊或一片铺开的地面拍摄时，那个面本来是斜着切进画面的，近的一头对实了，远的一头就虚；可只要让焦平面顺着它倒下去、整个贴上这个斜面，就能让一整片墙或一整片地从近到远一次拍实，而不必把光圈死收到 f/16、f/22 去硬凑景深、白白招来衍射。说到底，这两组动作各管一头，平移管的是透视，倾斜管的是景深。真正认真拍建筑外观时，用得最多的其实是平移，因为扶正竖线才是常态；倾斜则更多留给那些斜面、地面和大画幅式的精细活儿。分清了这一层，真正站到一栋楼跟前时，你才好判断自己缺的究竟是哪一样：是把倾倒的竖直线重新扶正，还是把一个斜过去的立面从头到尾拍实。

移轴的平移之所以能做到这一点，得从镜头投出的像说起。任何镜头投到机身内部的，其实是一个圆形的像，称作像场（image circle），而矩形的传感器只是从这个圆里截取中间的一块。普通镜头的像场，仅仅比传感器大出一圈余量，刚好够用；移轴镜头则特意把像场做得大出许多，于是像场相对传感器平移，传感器截取的区域随之改变。当你把取景范围整体上移，传感器截取的便是像场里偏上的那一部分，楼顶因此被收进画面，而传感器始终与立面平行，竖直线也就始终笔直。它的代价在于，一旦平移量推到极致，传感器就逼近了像场的边缘，画面的角落容易发暗，也就是所谓的暗角，或者变软，所以移轴用到尽头时，画质总要打一点折扣。

像场比传感器大出这么多，还顺手送了移轴一件第二本事：无视差接片。机身和镜头都固定不动，只挪动平移旋钮——先左移拍一张，回中拍一张，再右移拍一张——三张截取的是同一个像场里并排的三块，视点丝毫没变，近景远景之间不存在任何错位，后期几乎无缝地拼成一张两倍宽、像素也翻倍的大图。这比第 9 章讲的旋转接片省心得多：旋转接片要操心入瞳、要防近景错位，移轴接片压根没有这些问题，因为你转的不是相机，而是截取的窗口。竖移同理，上移、回中、下移三张，拼出一张长幅。建筑交付大图时，这一手几乎是移轴用户的常规操作——买一支移轴，等于顺带买了一台更大画幅的相机。
...
| 后期透视校正 | 在软件里把上窄下宽的梯形重新拉成矩形 | 顶部被拉伸、分辨率下降，边缘要裁掉一圈；校正后楼常显得矮胖，需再纵向拉伸约一成补偿 |
...
光则更微妙一些。正侧光最擅长交代建筑的体积和材质的质感，光从侧前方斜斜擦过，墙面的凹凸和砖石的纹理便一寸寸显了出来。而想让某一面立面吃上这样的光，时刻是可以倒推出来的：立面朝哪边，就决定了它在一天里的哪一段受光——东立面吃上午的光，西立面吃下午的光，南立面（在北半球）几乎整天有光可用，北立面则一年里只有夏天清晨和傍晚那一小会儿能沾到直射。这和第 9 章说山坡朝向是同一条道理。所以拍一栋楼之前，先在地图上看清它的朝向，再用 PhotoPills 这类工具查太阳的方位角，找出阳光以斜四十五度左右扫过这面墙的时刻——正对着立面照的光是平的，斜擦过去的光才起纹理——然后按那个钟点去。建筑不会动，太阳的路线也精确可查，这是建筑摄影比风光省心的地方：光可以约，不必碰。至于整座城市的建筑，最值得守候的黄金窗口，还要数蓝调时刻，此时室内外的灯光刚刚点亮，又恰好和天边尚存余晖的深蓝达成一种亮度上的平衡，楼体不至于黑成一片剪影，天空也不至于白得没有层次。

建筑对光的挑剔，其实没有风光那么苛刻，可这并不意味着光无关紧要，恰恰相反，不同的光会把同一栋楼变成完全不同的东西。直射的阳光能把墙面的纹理和阴影一刀刀切出来，因此格外适合混凝土、石材、楼梯、屋檐，以及那些本就强调光线的现代建筑。Tadao Ando 的许多空间，如果抽掉了硬光，墙面和缝隙之间那种紧张的关系，立刻就会弱下去大半。不过硬光自有它的麻烦，那就是反差太大：一面墙可能亮到彻底失去细节，另一面却又沉得过深，几乎什么都看不见。拍这类建筑时，要先在心里定下一件事，你究竟要的是一个完整的立面，还是光和影切割出来的那一处局部。倘若要的是完整的记录，阴天反而更稳妥；倘若要的是建筑的戏剧性，那么直射光就值得你耐着性子去等。其实还有第三条路：建筑不会动，正是包围曝光最理想的对象——架稳三脚架，围绕基准各拍一档保高光、一档提暗部，回去把亮墙与暗墙各自合适的部分融在一起，换算和取舍照第 9 章那一套来。硬光下的完整立面，未必只能在“等阴天”和“舍一头”之间二选一。
...
美国建筑摄影师 Julius Shulman 在 1960 年为 Pierre Koenig 设计的第 22 号案例住宅（Stahl House）拍的那张照片，常被人拿来当作这种平衡的范本。画面里，一间四壁皆玻璃的客厅悬挑在半空，两位女子坐在灯火通明的室内，脚下则是洛杉矶铺开的万家灯火。Shulman 的做法值得拆开来学：他用长时间曝光去积累远处城市微弱的灯火，让整片夜景在底片上慢慢显形；可几分钟的曝光里，人是坐不住的，于是他再用闪光灯在曝光中把室内和两位女子“凝”下来——闪光那一瞬间的亮度定住了人，长曝的时间积累出了城，两种时间被压进同一张底片。这正是第 6 章讲过的慢门同步在建筑里的用法。那张照片后来几乎成了那栋房子本身的代名词，可它真正拍下的，其实是那一小段冷暖恰好两全的光，加上一手把两种光源分开算账的功夫。

雨后和雾中，也都值得专门挑这样的天气出门。雨后湿漉漉的地面，会像一面镜子那样，把楼和灯统统倒映回来；雾则会把远处高楼的下半截整个吞掉，只留下顶部孤零零地浮在半空中。许多城市在大晴天里其实平平无奇，可一旦罩进雾里，反而生出了一点只属于它自己的秘密。拍雾天有两笔技术账要先记下：其一，雾是亮场景，和雪同理，测光表会把满画面的灰白往中灰上压，把雾拍得又灰又闷，通常要主动加大半档到一档曝光，让雾回到它本来的亮；其二，白平衡别急着把雾里那点青蓝校掉，那层冷色正是雾的体温。器材上还有一件事：从暖的车里、屋里走进冷雾，镜片会立刻蒙上一层结露，急不得，把相机连包在室外放上十来分钟，让它自己降到环境温度再开工，拿布反复去擦只会越擦越花。
...
城市摄影比单纯的建筑，多出了人和时间这两样东西。天际线是其中门槛最低、也最容易拍得千篇一律的一种。机位决定一大半：桥上能把河道当前景，山顶和观景台给你把整座城压成图案的高度，高楼的窗边则常常要对付玻璃反光——把镜头贴住玻璃、用衣服或遮光罩挡掉身后的室内灯，是行之有效的土办法。找机位不必从零开始，别人拍过什么角度，地图和图片搜索里一查便知，真正的功夫在于挑一个别人没等过的天气和钟点。街区这一层，则要把眼光从单栋楼放宽到组织方式上：一条街的骑楼怎样连成连续的檐口，店招怎样一层压一层地挤占立面，电线怎样把天空切成碎块——这些常被嫌乱的东西，恰恰是一座城市区别于另一座的指纹，与其绕开它们去找“干净”的画面，不如把这份密度本身当作主题，一条街一条街地拍成系列。至于街角，它其实已经很接近街头摄影了，一个人一个不经意的动作，都可能决定整张照片的成败。有一条经验值得记住：让建筑占去画面的大部分，人只在其中出现那么一点点，往往比把画面拍得满是人更耐看。建筑负责提供秩序，人则负责提供那个转瞬即逝的瞬间。
...
礼数之外，还有一层是法律，值得专门立一节说清楚，因为建筑摄影在这上面的误会格外多。基本盘是宽松的：站在公共道路上拍摄一栋建筑的外观，在绝大多数地方都合法，无须任何人的许可，建筑师和业主都拦不住你的镜头。分歧出在发表和商用这一层，各国的“全景自由”（freedom of panorama）宽窄不一：德国、英国这类地方，公共空间里的建筑随便拍随便发，商用也行；法国则把建筑当作品保护到设计师去世后七十年，最出名的例子是埃菲尔铁塔——铁塔本身早已过了保护期，白天怎么拍都行，可塔身上那套灯光秀是 1985 年的“作品”，夜间点亮的铁塔照片在法国严格说来不能未经授权商用，这桩轶事几乎成了讲全景自由必举的案例。往里走一层，商场、写字楼大堂、酒店、机场航站楼这些看似公共的空间，法律上是私人物业，物业有权立规矩、有权请你收起相机，被制止时配合就是。真接了商业委托去拍一栋楼，规矩再进一层：进入私人地界需要业主许可，成片商用最好把物业授权白纸黑字签下来。至于无人机航拍，则是另一套完全独立的法规——禁飞区、限高、飞手执照，各国各城自成体系，起飞之前把当地规则查清楚，是和检查电池同一级别的起飞前动作。
