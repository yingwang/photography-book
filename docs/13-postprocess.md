...
这里还有一个分寸问题。调整亮暗、色彩、局部明暗和裁剪，一般都属于摄影传统中长期存在的处理。压住天空、提亮脸、校正白平衡、让画面反差更合适，这些和暗房里的遮挡、加光并没有本质区别。可是到增删画面内容的时候，就要慢一点。把一个碍眼的人抹掉、把飞鸟贴进天空、把两张照片拼成一个本不存在的瞬间，改变的不只是照片长什么样，而是改变了现场发生过什么。
