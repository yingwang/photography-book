...
除了眼睛，人像还有一笔常被漏掉的技术账：肤色的曝光。测光表把一切都往中灰上拉，可人的肤色天然分布在中灰两侧——白皙的皮肤本该比中灰亮上大半档到一档，按表直拍会显得灰暗发闷，通常要加三分之二档上下；深色的皮肤本该比中灰沉，按表直拍反被提得发灰发假，该压的就压下去，按脸上的质感和高光来定，而不是按灰卡来定。一条在各种肤色上都通用的检查法是盯住高光：额头、颧骨上那几点反光可以亮，但不能白到没有细节，肤色的层次一旦在高光里溢出，后期便无从找回。逆光和大光比人像里，这一档半档的取舍，往往就是成片和废片的距离。
