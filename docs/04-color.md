...
还有一环必须点破，否则前面关于“准不准”的一切讨论都悬在空中：你用来判断颜色的那块屏幕，本身准不准。一块出厂就偏蓝、亮度又开到顶的显示器，会让你在不知不觉中把每张照片都往反方向补偿。校准要靠校色仪实测生成这块屏幕自己的特性文件，打印前还有软打样这道工序——这些属于后期的基础设施，第 13 章会专门讲。这里只需先立下一条意识：谈论颜色之前，先确认自己的眼睛和屏幕这条链路是可信的。
...
顺着光谱这条线，还有一个买灯、选场地时真正用得上的数字：**显色指数**（CRI）。它衡量的是一个光源把物体颜色照“全”的能力，满分 100，日光和钨丝灯的光谱连续完整，接近满分；而一些便宜的 LED 和荧光灯，光谱缺一块少一块，CRI 可能只有七八十。在低显指的光下，有些颜色根本就没有被照出来——光谱里缺红，肤色里那点红润无论怎么拍都不在，后期也无从还原，因为传感器压根没收到那份信息。所以挑常亮灯时认准 CRI 95 以上，讲究的再看看专管饱和红色的 R9 值；走进一个现场觉得人脸怎么看怎么灰败，先抬头看看那排灯，问题多半不在相机。
