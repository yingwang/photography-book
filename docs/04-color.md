...
第一个维度是**色温**（color temperature），单位是开尔文（K），管的是暖-冷、也就是黄-蓝这条轴。这里有一处反直觉的地方：色温越高，颜色反而越偏蓝、越「冷」。原因是这个数值本来描述的是一块黑体被加热到某温度时发出的光，铁烧到一千多度是红的，烧到近万度就泛蓝，所以一千九百开的烛光是暖橙，六千五百开的日光接近中性，上万开的蓝天阴影则冷得发青。摄影师口中的冷暖，和物理上的高低温正好相反。
