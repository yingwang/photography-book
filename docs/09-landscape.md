...
风光器材的逻辑，和街头、人像那一套都不太一样。三脚架就是一个典型的例子，它比很多人以为的要重要得多。带三脚架不是为了显得专业，而是为了让你在慢门、低 ISO、精准构图和长时间等待里有稳定支点。一个真正合用的三脚架，要能承受相机与镜头的实际重量，锁紧后不缓慢下沉，收起来又不能重到让你每次都把它留在家里。碳纤维通常比同等级铝架轻、触感不那么冰，并可能有更好的振动阻尼；但“更轻”本身不等于大风里更稳，抗风还取决于脚管直径、节数、展开高度、云台、重心与迎风面积。到现场应尽量缩短中轴、张开脚管，并用相机背带或身体挡风，而不是只看材质标签。
