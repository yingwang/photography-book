...
前后的距离同样是一个旋钮。窗光也逃不开后面要讲的反平方定律：人离窗一米时，脸上亮侧和暗侧、脸和身后背景的落差都大，画面偏戏剧；退到三米开外，光衰减掉大半，反差变平，人也更容易和背景糊在一起。你在窗边让人前后挪半步、头转一点，其实就是在徒手调整一整套布光参数，只是没有灯架和柔光箱而已。
...
两边都重要，就等。等太阳被云挡住一半，反差降下来，你就有机会同时保住。这一等并不是玄学：一片云飘到太阳前面，等于把那个 0.5° 的点光源换成了一整片几十度的柔光箱，直射光被摊开，场景两端的反差在几秒钟里就能掉下来两三档，原本救不回的暗部忽然就都进了相机的量程。所以老练的人在大反差场景前常常先抬头看云的走向，算的就是这一下。等不到，也还有别的路：换一个角度，让亮部和暗部在画面里换一种比例；风光里天亮地暗的经典难题，还可以在镜头前加一片渐变灰滤镜（GND），上半段灰、下半段透明，把天空单独压下来两三档，等于用一块玻璃替你把反差先削了一层，第 9 章讲风光时会再回到它。实在不行，就承认今天不成，明天再来。
