...
日落前约一小时起，直到太阳沉下去，是晚黄金。它比早黄金更戏剧，因为白天的对流把灰尘、水汽和城市的烟尘搅进了低空，傍晚的阳光斜穿过这层比清晨浑浊得多的空气，短波的蓝绿光被滤走得更彻底，剩下的光就比清晨更红、更稠，也更“脏”得有味道；云也更容易在下午晚段出现层次。光每隔几分钟就会变一次，画面里的色温也跟着走，同一个机位每隔几分钟都可能给你一张不一样的照片。
...
黑白也常常需要硬光。反差是黑白的语言。硬光下的彩色片有时显得刺眼，转成黑白之后，那种反差会变成结构。Daido Moriyama 拍新宿、涩谷街头时，并不总是避开中午和下午的直射光。他出身于 1968 年前后聚集在《Provoke》杂志周围的那一批日本摄影师，那本只出了三期的小杂志，公然把“粗劣、晃动、失焦”（アレ・ブレ・ボケ）当成纲领，故意背弃当时以干净、准确为荣的主流品味。要成全这种美学，硬光几乎是必需品：正午的直射阳光先把街道劈成大块的亮与暗，再经他惯用的高反差冲印和放印一压，灰阶被两头挤掉，白的更白，黑的成片沉死，画面里剩下的就只有形状和颗粒。他那张著名的《野犬》，狗身上纠结的毛、地面的粗砺，全靠白天的直射光顶着；换成阴天，那条狗多半只是条狗。光越硬，画面越粗粝，越接近他要的状态。
...
会看反差的人，站在场景里时，会自动忽略相机根本留不住的部分。肉眼能看见很多细节，相机未必能同时保住。这并不是因为眼睛这台“传感器”本身宽出多少，而是因为人眼从不老老实实地一次成像：瞳孔在随亮度开合，视网膜的增益在随注视点调整，你看向阴影时它替你增感，看向高光时又替你减档，一路看下来再由大脑拼成一幅两头都有细节的印象，综合起来覆盖的范围远超任何传感器一次曝光所能记录的。成熟的摄影师看到的，已经接近相机能拍下来的样子。他知道哪些会留下，也知道哪些会消失，于是在按下快门之前，他心里已经替相机做完了这道取舍。
...
这张表从上往下，是从平走到硬。顺带说清一个容易被绕晕的地方：严格地讲，亮侧接受的是主光加补光的总和，暗侧只有补光，所以“补光比主光弱两档”换算成亮暗两侧之比，其实是 (4+1):1，即 5:1 而不是 4:1；影室里的习惯说法常把补光落在亮侧的那一份忽略掉，直接把主补的强度比喊成布光比。两种口径都在流传，差半档上下，日常拍摄不必细抠，本书统一按亮侧比暗侧的口径来说，你在别处听到数字对不上时，知道分歧出在哪里就够了。新手拍人常不自觉地停在 1:1 附近，因为补光加得越足越安全，可太安全的光也最没有性格，脸容易发扁。想让脸立起来，多半要往 3:1、4:1 走：让主光偏到一侧，再用补光把暗部托到比亮侧低一档半到两档的位置，既留住了立体，又不至于让暗部黑到没有细节。补光可以是一盏灯，也可以只是一块白卡、一面墙，甚至暗侧那半间屋子的环境光。
...
空气对画面做的事还不止改颜色，它也在悄悄塑造纵深。空气里的水汽和尘埃会把穿行其间的光再散射一遍，于是离你越远的东西，隔着的空气越厚，被冲淡得越厉害：反差降下来，颜色褪一层，蒙上一点偏蓝的灰。画里管这个叫大气透视（aerial perspective），山水摄影里那种一重山比一重山淡、层层退向天边的效果，靠的正是它。雾天更是把这层效果推到极处，几十米外的东西就开始被抹平，画面天然分出前中后三层，杂乱的背景全被雾替你收拾干净，所以雾从来不是坏天气，而是一只免费的景深整理器。空气里的悬浮物够多时，光的路径本身也会显形：清晨树林里斜插下来的光柱，教堂天窗下悬着灰尘的那一道亮，都是光被水汽和尘埃从侧面散射进你眼睛的结果，人称丁达尔效应。想拍到它，要点有二：一是空气里得有东西，雾、灰尘、水汽、烟；二是必须逆着光或侧逆着光看，顺光方向那些光柱根本不显。下次雾天清早，别嫌天灰，往树林或街口找那道斜光去。
