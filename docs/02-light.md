...
更稳的反应，是在拿相机之前先把光看一遍。光从西边低处斜穿过院子，硬度很高，砂面上被扫过的纹路一条条都很清楚；金光和阴影之间差得很远，曝光不可能两边都照顾得一样舒服；下午偏晚的光比正午更黄，角度也更低，黑色衣服一走进去，轮廓会被衬得很清楚。
...
第三种是轮廓光。主体头发、肩膀、毛绒外套的边缘，被背后来的光镶上一道亮边，人和背景之间就有了清楚的分离。拍商业人像的常把时间约在黄昏，就是因为这半小时天然给你一道金边。让模特背对夕阳，前面用白卡或反光板补一点脸的亮度，头发和肩膀就会自己亮起来。
...
日落前约一小时起，直到太阳沉下去，是晚黄金。它比早黄金更戏剧，因为白天的对流把灰尘、水汽和城市的烟尘搅进了低空，傍晚的阳光斜穿过这层比清晨浑浊得多的空气，短波的蓝绿光被滤走得更彻底，剩下的光就比清晨更红、更稠，那一点浑浊反而添了几分戏剧的味道；云也更容易在临近傍晚时出现层次。光每隔几分钟就会变一次，画面里的色温也跟着走，同一个机位每隔几分钟都可能给你一张不一样的照片。
...
主体正对窗户时容易眯眼，脸也太平；背对窗户时又很容易变成剪影，除非你本来就想要这个效果。大多数时候，侧对窗户会舒服很多。设想你和朋友坐在咖啡馆靠窗的位子上，想给对面的人拍一张：只要请他把椅子往旁边挪一点，让脸和窗户大约成四十五度，光就会从侧前方绕过来，鼻梁一侧亮、一侧暗，脸立刻立起来。

侧对之后，还有一个更细的选择：让脸转向窗，还是转离窗。脸转离窗户时，受光的那半边脸随之转向相机，亮面宽、阴影窄，人像布光里叫宽光（broad lighting），脸会显得开阔一些，也难免显得胖一点；脸朝向窗户时，对着相机的反而是背光的那半边，画面里大部分是阴影过渡，这叫窄光（short lighting），脸颊被收窄，五官的起伏也更深，古典人像里十有八九用的是它。同一扇窗、同一个人，头转过去二十度，观感就是两种。

前后的距离同样是一个旋钮，但窗不是理想点光源，不能把反平方定律直接套成“离窗三倍就只剩九分之一”。靠近窗时，它在主体眼里更大，通常更软、更亮；人物、暗侧脸与背景到窗的相对距离也会一起改变，反差可能增加，也可能被浅色墙面的反射填平。最可靠的做法，是让人前后移动半米，直接比较鼻影、暗侧与背景，而不是背一个固定结论。
...
*Johannes Vermeer，《倒牛奶的女仆》，约 1658。光从画面左侧那扇窗进来，斜打在女仆的额头、手臂和那一股细细的牛奶上，右半边自然落进柔和的阴影。这正是上文说的窗光：大窗、白墙，人侧对着光站。绘画比摄影早了近两百年，已经把这一套光用熟了。(Rijksmuseum, 公有领域)*
...
剪影需要硬光。主体在背景前像被切出来一样干净，软光下那种边缘过渡反而会让剪影的轮廓发绵，少了那份干脆。肌理也需要硬光。老人脸上的皱纹、墙面的裂缝、生锈金属上的颗粒、粗麻布的纹路，都靠细小阴影描出来。质感其实是无数细小的凹凸投出的无数细小阴影，而只有硬光才能在每一道凹陷里都填进一笔黑。侧面打下来的硬光，会把这些阴影一一挖深，材质感立刻起来。

Sebastião Salgado 1986 年在巴西 Serra Pelada 金矿拍的那组黑白照片，很多就是这种光。近赤道的硬阳光打在工人被黑泥糊住的背、脸和手上，每一块肌肉、每一道汗痕、每一颗泥粒都像浮雕。换成阴天漫射光，那一组就不是那个力量。

黑白也常常需要硬光。反差是黑白的语言。硬光下的彩色片有时显得刺眼，转成黑白之后，那种反差会变成结构。Daido Moriyama 拍新宿、涩谷街头时，并不总是避开中午和下午的直射光。他出身于 1968 年前后聚集在《Provoke》杂志周围的那一批日本摄影师，那本只出了三期的小杂志，公然把“粗劣、晃动、失焦”（アレ・ブレ・ボケ）当成纲领，故意背弃当时以干净、准确为荣的主流品味。要成全这种美学，硬光几乎是必需品：正午的直射阳光先把街道劈成大块的亮与暗，再经他惯用的高反差冲印和放印一压，灰阶被两头挤掉，白的更白，黑的成片沉死，画面里剩下的就只有形状和颗粒。他那张著名的《野犬》，狗身上纠结的毛、地面的粗粝，全都靠白天的直射光撑着；换成阴天的漫射光，那条狗多半就只是一条寻常的狗了。光越硬，画面越粗粝，越接近他要的状态。
...
拿这把尺子回头量太阳，前面那个看似矛盾的说法就通了。太阳的直径是地球的一百多倍，绝对尺寸大得惊人，可它离我们一亿五千万公里，在地面上望过去，只张开约 0.5° 的角，和一枚一元硬币举到两米半开外差不多大。角这样小，等于一个几乎是点的光源，所以晴天的太阳是标准的硬光，影子边缘利落得像刀切。云和窗户则相反：一片云、一整片阴天的天空、一扇贴着人的大窗，本身够大、又离主体够近，在主体那里张开的角可以有几十度，于是同一束阳光被摊成了软光。你在窗边把人往窗口挪近半米，窗在脸上张开的角就大了一截，光当场就软一分，靠的正是这个道理。

对付镜面反射，除了改光源，还有一件专门的工具值得在这里交代：偏振镜（CPL）。光从水面、玻璃、树叶蜡质表层这类非金属表面斜着弹回来时，反射光会带上偏振，也就是振动方向被压到了某一个平面上；偏振镜就是一道只放行特定振动方向的栅栏，把它拧到合适的角度，那层反光就被滤掉大半。于是水面沉下去露出水底的石头，橱窗玻璃退开露出里面的陈设，雨后的树叶不再泛着一层白，颜色整个深下来。它还有第二个用处：晴天的蓝天光本身就是被大气散射出来的，散射光同样带偏振（本章末尾讲天空为什么蓝时会再遇到它），所以对着与太阳成直角的那片天，偏振镜能把蓝压得更深、云衬得更白。代价也要记住两条：它要吃掉一到两档光；用在超广角上时，天空中被压暗的只有那一条与太阳成直角的带，画面里的蓝会深浅不匀。金属的反光是个例外，它弹回来的光几乎不偏振，偏振镜对它无能为力。
...
现在相机的测光已经很准，你未必真要靠它来拍。可它仍值得记住：一是相机没电、测光表指望不上，或是逆光、雪地这类容易骗过它的场合，它给你一个心里有底的基准；二是它逼着你把天气、影子和曝光三者在脑海里连起来，久了你只要抬头看一眼天，手就知道该往哪个方向拧。
...
反差是画面最亮处和最暗处的距离，单位是档；一档代表亮度相差一倍。相机能在给定噪声标准下同时区分的跨度叫动态范围，它会随机型、ISO、RAW 模式、测量门槛和输出尺寸变化，不能用“全画幅十四档”概括所有相机。现场判断仍要回到重要高光是否削波、重要暗部是否有可用信噪比。

晴天中午站在阴影里，看阳光下的街道，从阳光下发亮的白墙到骑楼阴影的深处，场景两端的反差可能有六到八档。这样的场景没有一个能让两边都舒服的“正确曝光”。给阴影曝光，街道会白成一片；给街道曝光，阴影会变成一块黑。取中间值看似安全，最后常常两边都灰、都脏。
...
两边都重要，可以等云层削弱直射光，让天空成为更大、更均匀的主要光源。反差能下降多少取决于云的厚度、覆盖范围、地面反射和背景，不一定恰好是两三档；到云边时还可能短暂变亮。老练的人会看云的走向，也会在变化发生后重新读直方图。等不到，还可以换角度、补光、做包围曝光，或在适合的地平线使用渐变灰滤镜；实在不行，就承认今天的光不支持原先那张照片。

会看反差的人，站在场景里时，会自动忽略相机根本留不住的部分。肉眼能看见很多细节，相机未必能同时保住。这并不是因为眼睛这台“传感器”本身宽出多少，而是因为人眼从不老老实实地一次成像：瞳孔在随亮度开合，视网膜的灵敏度在随注视点调整，你看向阴影时，它悄悄调高增益；看向高光时，又把灵敏度压低下来，一路看下来，再由大脑拼成一幅两头都有细节的印象，综合起来覆盖的范围，远超任何传感器一次曝光所能记录的。成熟的摄影师看到的，已经接近相机能拍下来的样子。他知道哪些会留下，也知道哪些会消失，于是在按下快门之前，他心里已经替相机做完了这道取舍。
...
这张表从上往下，是从平走到硬。顺带说清一个容易被绕晕的地方：严格地讲，亮侧接受的是主光加补光的总和，暗侧只有补光，所以“补光比主光弱两档”换算成亮暗两侧之比，其实是 (4+1):1，即 5:1 而不是 4:1；影室里的习惯说法常把补光落在亮侧的那一份忽略掉，直接把主光与补光的强度之比称作布光比。两种口径都在流传，相差半档上下，日常拍摄不必深究，本书统一按亮侧比暗侧的口径来说，你在别处听到数字对不上时，知道分歧出在哪里就够了。新手拍人常不自觉地停在 1:1 附近，因为补光加得越足越安全，可太安全的光也最没有性格，脸容易发扁。想让脸立起来，多半要往 3:1、4:1 走：让主光偏到一侧，再用补光把暗部托到比亮侧低一档半到两档的位置，既留住了立体，又不至于让暗部黑到没有细节。补光可以是一盏灯，也可以只是一块白卡、一面墙，甚至暗侧那半间屋子的环境光。
...
布光比管的是明暗两侧差多少，它还没有回答另一半问题：阴影长成什么形状。同样是 4:1 的反差，光从侧面来还是从正上方来，脸上的影子完全是两副样子。人像布光传统里给几种最常用的形状起了名字，值得放在一起认一遍。主光在脸的斜前方约四十五度、略高于眼睛，鼻影斜着落下来、和脸颊的阴影连成一片，只在暗侧颧骨上留下一小块三角形的亮，这是伦勃朗光（Rembrandt lighting），名字来自这位画家肖像里反复出现的那块三角光，情绪重，适合男性和有故事的脸。把主光的角度收浅一点，鼻影短短地垂下来、不与颊影相连，围着鼻侧绕成一个小环，这是环形光（loop lighting），人像里最通用、最不出错的一种。主光移到脸的正前方并抬高，鼻子正下方压出一小片蝴蝶形状的影子，这是蝴蝶光（butterfly lighting），好莱坞棚拍时代用它拍女明星，因为正面高位的光会强调颧骨、收窄脸颊。主光干脆移到正侧面，把脸劈成一亮一暗两半，这是分割光（split lighting），戏剧性最强，也最挑人。再加上前面窗光一节讲过的宽光与窄光，这几个名字合起来，就是一套完整的人像用光词汇：布光比说反差多大，光位说阴影长什么样，两者各管一半，合在一起才描述得清一张脸上的光。

这些名字虽然来自影室，却不是影室的专利。窗光、路灯、咖啡馆的吊灯，任何一个方向明确的光源，都在人脸上打出这几种形状里的某一种，区别只在于影室里是灯就人、现场里是人就光。顺带把话说全：整章讲的都是自然光，可闪光灯和常亮灯并不在这套规律之外，它们不过是一颗被你攥在手里的太阳，方向、角大小、距离全都听你指挥——加个柔光箱是把角撑大，拉远是让反平方替你削弱，打向天花板是把整个屋顶变成光源。你在本章学会的每一条，从光位到布光比到反平方，搬到灯上一条都不用改。

---

## 色温与白平衡

色温是光的颜色，单位是 K。数值越低，光越偏暖，越往红黄走；数值越高，光越偏冷，越往蓝走。烛光大约 1800 到 2000K，钨丝灯 2700 到 3000K，太阳贴着地平线时约 2000 到 3000K，升高一些后很快走向 4000K 以上，下午阳光 5000 到 5500K，正午和阴天会更冷，蓝调时刻可以到 9000K 以上。
...
不过色温只说清了颜色的一半。它描述的是一条从暖到冷、从橙到蓝的轴，可现实里的光还会在另一条与它垂直的轴上跑偏，那条轴从绿到品红，摄影里管它叫色调（tint）。太阳、烛火、白炽灯这些靠加热发光的光源，颜色老老实实落在暖冷这条轴上，报一个色温值就能交代清楚；荧光灯、水银灯还有某些 LED 却不是靠加热发光的，它们的光谱缺一块少一块，往往整体泛着一层绿，光凭色温这一个数怎么也说不准，还得在色调这条轴上朝品红方向拉一点，才能把那层绿抵消掉。后期软件里白平衡之所以总是色温、色调两个滑块并排摆着，正是因为要还原一束光真正的颜色，本就得让这两条轴同时出手。
...
混色光是色彩的杀手。一个场景里同时有窗光和钨丝灯，左半边发蓝，右半边发黄，皮肤很容易脏。这是因为两种光常常不只色温不同，连色调也不落在同一条轴上——钨丝灯规规矩矩待在暖冷轴上，荧光灯却偏着绿——你无论把白平衡的色温和色调拧到哪一头，都只能校准其中一种光，另一种立刻偏色。很多咖啡馆人像看起来不干净，原因就在这里。与其回家以后在后期里反复补救，不如现场关掉其中一种光，或者换一个位置。混色光能避就避，修起来费力，还未必自然。
...
空气对画面做的事还不止改颜色，它也在悄悄塑造纵深。空气里的水汽和尘埃会把穿行其间的光再散射一遍，于是离你越远的东西，隔着的空气越厚，被冲淡得越厉害：反差降下来，颜色褪一层，蒙上一点偏蓝的灰。画里管这个叫大气透视（aerial perspective），山水摄影里那种一重山比一重山淡、层层退向天边的效果，靠的正是它。雾天更是把这层效果推到极处，几十米外的东西就开始被抹平，画面天然分出前中后三层，杂乱的背景全被雾替你收拾干净，所以雾从来不是坏天气，倒像是老天白送的一层帮你收拾背景的纱幕。空气里的悬浮物够多时，光的路径本身也会显形：清晨树林里斜插下来的光柱，教堂天窗下悬着灰尘的那一道亮，都是光被水汽和尘埃从侧面散射进你眼睛的结果，人称丁达尔效应。想拍到它，要点有二：一是空气里得有东西，雾、灰尘、水汽、烟；二是必须逆着光或侧逆着光看，顺光方向那些光柱根本不显。下次雾天清早，别嫌天灰，往树林或街口找那道斜光去。
...
很多人按完一张就走，问题是光还在变，人物还在变，刚才那张未必就是最好的那张。老练的拍法有个说法，叫“把一个场景做完”（work the scene）：先认定这里的光和背景值得经营，再围着它换角度、换距离、等人物，把这一处的可能性一样样试过去，直到确认再没有更好的一张，才走。Saul Leiter 是这门功课最安静的示范。他常常先被一样不动的东西留住，一扇蒙着水汽的橱窗玻璃，一柄立在雪地里的红伞，一块雨棚投下的影子，然后就守在那里，等一个行人、一辆出租车、一团呵出的白气恰好走进这层光里。他那些著名的画面，《Snow》里隔着结霜玻璃洇开的人影，红伞在一片灰雪里烧出的那一点颜色，都不是撞上的，而是先认定了光，再把人等进来的。最后留下来的那一张可能成了封面，没留下来的那些照片，观众永远不会看到。
