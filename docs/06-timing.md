...
*Eadweard Muybridge, "The Horse in Motion", 1878。Leland Stanford 当年和朋友打赌：马奔跑时，会不会有四蹄完全离地的一瞬间。为了证明这件事，他雇 Muybridge 在 Palo Alto 的赛道边布了一排连环相机，每台快门由马经过时绊触的细线触发。这组照片证实了答案：马在某一帧里确实四蹄离地。摄影第一次把人眼看不到的瞬间变成了证据。时机作为一个摄影问题，从这里开始变得非常具体。 (Library of Congress, 公有领域)*
...
他在卷首引了红衣主教 de Retz 的一句话：任何事物里，都藏着一个决定性的瞬间。Cartier-Bresson 自己接着说，在那创造性的几分之一秒里，意识对一个发展中的局面越来越敏锐，然后手指落下，按下快门。

这段话真正的重点，落在“发展中的局面”这几个字上。意识并不是在某一刻突然变敏锐的，它是在持续不断的观看里，一点一点被调动、被磨利。时机考验的并不只是你的反应够不够快，更考验你愿不愿意在一个场景面前停留下来，一直看，直到看出这件事接下来可能朝哪个方向发展。好的时机往往属于那些肯多站一会儿的人，而不是路过时随手一按的人。
...
街头、人像、风光、建筑，这些题材在大多数时候都可以用单帧来拍。单帧有一个不易察觉的好处，它会不断训练你的判断，因为每按一张，你都必须主动地做一次决定，而不是把选择推迟到事后。它同时也替你省下大量选片的时间，让你回家以后不必对着一大堆几乎一模一样的照片发愁。老一代的街头摄影师几乎清一色用单帧，这固然是因为当年的机器还没有今天这样的连拍能力，可正是这个限制反过来逼着他们在按下快门之前，先把画面想清楚。约束本身成了一种训练。
